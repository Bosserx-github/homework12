                        ...
                        children: [
                          Container(//1
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: Colors.black, width: num1),
                            ),
                          ...
                          Container(//2
                            ...
                            decoration: BoxDecoration(
                              color: Colors.white,
                              shape: BoxShape.circle,
                              border: Border.all(color: Colors.black, width: num2),
                            ),
                          ...
                          Container(//3
                            ...
                            decoration: BoxDecoration(
                              color: Colors.white,
                              shape: BoxShape.circle,
                              border: Border.all(color: Colors.black, width: num3),
                            ),
                          ...
                          Container(//4
                            ...
                            decoration: BoxDecoration(
                              color: Colors.white,
                              shape: BoxShape.circle,
                              border: Border.all(color: Colors.black, width: num4),
                            ),
                          ...
                          Container(//5
                            ...
                            decoration: BoxDecoration(
                              color: Colors.white,
                              shape: BoxShape.circle,
                              border: Border.all(color: Colors.black, width: num5),
                            ),
                          ...
                          Container(//6
                            ...
                            decoration: BoxDecoration(
                              color: Colors.white,
                              shape: BoxShape.circle,
                              border: Border.all(color: Colors.black, width: num6),
                            ),
            ...
            Container(
              child: InkWell(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text('$num', style: TextStyle(fontSize: 20,color: Colors.black,fontWeight: FontWeight.bold)),
                  ],
                ),
              ),
              width: 75.0,
